import { type Coords, evaluate, getAlignment, getSide, getSideAxis } from '../../utils'
...
export async function convertValueToCoords(state: MiddlewareState, options: OffsetOptions): Promise<Coords> {
