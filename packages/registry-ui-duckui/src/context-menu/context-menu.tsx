...
function ContextMenuTrigger(props: React.ComponentPropsWithoutRef<typeof DropdownMenuTrigger>) {
  ...
  React.useEffect(() => {
    ...
    triggerRef.current?.addEventListener('contextmenu', (e) => {
      ...
      const items = content?.querySelectorAll('duck-context-menu-item')
      console.log(items)
  ...
  return (
    <DropdownMenuTrigger
      ...
      className="bg-background w-[300px] h-[200px] p-2 border-dashed hover:bg-background [&>div]:justify-center [&>div]:w-full"
      style={
        {
          '--position-anchor': '',
