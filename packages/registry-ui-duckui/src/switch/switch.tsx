  ...
  return (
    <input
      ...
      className={cn(
        ...
        'after:absolute relative after:bg-white after:rounded-full after:block checked:after:translate-x-[82%] after:size-4  after:duration-200 after:will-change-[width,transform] after:ease-(--duck-motion-ease) after:transition-all after:shadow',
        ' ',
        className,
      )}
      {...props}
