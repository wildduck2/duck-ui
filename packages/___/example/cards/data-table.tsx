...
import { Card, CardContent, CardDescription, CardHeader, CardTitle, Checkbox, 
  DropdownMenu,
  ...
  DropdownMenuTrigger,Input, Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/registry/default/ui/'
