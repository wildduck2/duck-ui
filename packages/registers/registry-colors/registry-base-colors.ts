...
export const baseColorsOKLCH = {
  ...
  slate: {
    light: {
      ...
      foreground: 'oklch(0.14 0.04 259.21)',
      muted: 'oklch(0.97 0.01 0)',
      'muted-foreground': 'oklch(0.55 0.04 257.45)',
      popover: 'oklch(1 0 0)',
      'popover-foreground': 'oklch(0.14 0.04 259.21)',
      card: 'oklch(1 0 0)',
      'card-foreground': 'oklch(0.14 0.04 259.21)',
      border: 'oklch(0.93 0.01 255.67)',
      input: 'oklch(0.93 0.01 255.67)',
      primary: 'oklch(0.21 0.04 265.77)',
      'primary-foreground': 'oklch(0.98 0 0)',
      secondary: 'oklch(0.97 0.01 0)',
      'secondary-foreground': 'oklch(0.21 0.04 265.77)',
      accent: 'oklch(0.97 0.01 0)',
      'accent-foreground': 'oklch(0.21 0.04 265.77)',
      destructive: 'oklch(0.61 0.24 26.07)',
      'destructive-foreground': 'oklch(0.98 0 0)',
      ring: 'oklch(0.14 0.04 259.21)',
      radius: '0.5rem',
    },
    dark: {
      background: 'oklch(0.14 0.04 259.21)',
      foreground: 'oklch(0.98 0 0)',
      muted: 'oklch(0.28 0.04 260.05)',
      'muted-foreground': 'oklch(0.71 0.04 256.83)',
      popover: 'oklch(0.14 0.04 259.21)',
      'popover-foreground': 'oklch(0.98 0 0)',
      card: 'oklch(0.14 0.04 259.21)',
      'card-foreground': 'oklch(0.98 0 0)',
      border: 'oklch(0.28 0.04 260.05)',
      input: 'oklch(0.28 0.04 260.05)',
      primary: 'oklch(0.98 0 0)',
      'primary-foreground': 'oklch(0.21 0.04 265.77)',
      secondary: 'oklch(0.28 0.04 260.05)',
      'secondary-foreground': 'oklch(0.98 0 0)',
      accent: 'oklch(0.28 0.04 260.05)',
      'accent-foreground': 'oklch(0.98 0 0)',
      destructive: 'oklch(0.57 0.2 26.34)',
      'destructive-foreground': 'oklch(0.98 0 0)',
      ring: 'oklch(0.28 0.04 260.05)',
      radius: '0.5rem',
    },
  },
  ...
  stone: {
    light: {
      ...
      'muted-foreground': 'oklch(0.55 0.01 57.99)',
      popover: 'oklch(1 0 0)',
      ...
      primary: 'oklch(0.22 0.01 0)',
      'primary-foreground': 'oklch(0.98 0 0)',
      secondary: 'oklch(0.97 0 0)',
      'secondary-foreground': 'oklch(0.22 0.01 0)',
      accent: 'oklch(0.97 0 0)',
      'accent-foreground': 'oklch(0.22 0.01 0)',
      destructive: 'oklch(0.61 0.24 26.07)',
      'destructive-foreground': 'oklch(0.98 0 0)',
      ring: 'oklch(0.15 0 0)',
      radius: '0.5rem',
    ...
    dark: {
      ...
      foreground: 'oklch(0.98 0 0)',
      muted: 'oklch(0.27 0.01 0)',
      'muted-foreground': 'oklch(0.72 0.01 0)',
      popover: 'oklch(0.15 0 0)',
      'popover-foreground': 'oklch(0.98 0 0)',
      card: 'oklch(0.15 0 0)',
      'card-foreground': 'oklch(0.98 0 0)',
      border: 'oklch(0.27 0.01 0)',
      input: 'oklch(0.27 0.01 0)',
      primary: 'oklch(0.98 0 0)',
      'primary-foreground': 'oklch(0.22 0.01 0)',
      secondary: 'oklch(0.27 0.01 0)',
      'secondary-foreground': 'oklch(0.98 0 0)',
      accent: 'oklch(0.27 0.01 0)',
      'accent-foreground': 'oklch(0.98 0 0)',
      destructive: 'oklch(0.57 0.2 26.34)',
      'destructive-foreground': 'oklch(0.98 0 0)',
      ring: 'oklch(0.87 0 0)',
  ...
  gray: {
    light: {
      background: 'oklch(1 0 0)',
      foreground: 'oklch(0.13 0.03 261.7)',
      muted: 'oklch(0.97 0 0)',
      'muted-foreground': 'oklch(0.55 0.02 264.42)',
      popover: 'oklch(1 0 0)',
      'popover-foreground': 'oklch(0.13 0.03 261.7)',
      card: 'oklch(1 0 0)',
      'card-foreground': 'oklch(0.13 0.03 261.7)',
      border: 'oklch(0.93 0.01 0)',
      input: 'oklch(0.93 0.01 0)',
      primary: 'oklch(0.21 0.03 264.68)',
      'primary-foreground': 'oklch(0.98 0 0)',
      secondary: 'oklch(0.97 0 0)',
      'secondary-foreground': 'oklch(0.21 0.03 264.68)',
      accent: 'oklch(0.97 0 0)',
      'accent-foreground': 'oklch(0.21 0.03 264.68)',
      destructive: 'oklch(0.61 0.24 26.07)',
      'destructive-foreground': 'oklch(0.98 0 0)',
      ring: 'oklch(0.13 0.03 261.7)',
      radius: '0.5rem',
    },
    dark: {
      background: 'oklch(0.13 0.03 261.7)',
      foreground: 'oklch(0.98 0 0)',
      muted: 'oklch(0.28 0.03 256.87)',
      'muted-foreground': 'oklch(0.71 0.02 261.41)',
      popover: 'oklch(0.13 0.03 261.7)',
      'popover-foreground': 'oklch(0.98 0 0)',
      card: 'oklch(0.13 0.03 261.7)',
      'card-foreground': 'oklch(0.98 0 0)',
      border: 'oklch(0.28 0.03 256.87)',
      input: 'oklch(0.28 0.03 256.87)',
      primary: 'oklch(0.98 0 0)',
      'primary-foreground': 'oklch(0.21 0.03 264.68)',
      secondary: 'oklch(0.28 0.03 256.87)',
      'secondary-foreground': 'oklch(0.98 0 0)',
      accent: 'oklch(0.28 0.03 256.87)',
      'accent-foreground': 'oklch(0.98 0 0)',
      destructive: 'oklch(0.57 0.2 26.34)',
      'destructive-foreground': 'oklch(0.98 0 0)',
