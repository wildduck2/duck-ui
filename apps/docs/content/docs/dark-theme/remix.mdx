---
title: remix
description: Adding dark theme to your remix app.
---
...
Add `:root[class~="dark"]` to your tailwind.css file. This will allow you to use the `dark` class on your html element to apply dark theme styles.
