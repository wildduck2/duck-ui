...
The `Pagination` component uses the `[Command](/components/command)`, `[Button](/components/button)` and `[Popover](/components/popover)` component. Make sure you have it installed in your project.
