...
## About
This component uses the [@gentleduck/duck-vim](https://github.com/gentleeduck/ui/tree/master/packages/duck-vim) library under the hood.
...
```bash
npm install @gentleduck/duck-vim @gentleduck/duck-libs
```
