...
```bash
npx duck-ui@latest add carousel
```
...
```bash
npm install embla-carousel-react @gentleduck/duck-libs
```

<Step>Add the `Button` component to your project.</Step>

The `Carousel` component uses the `[Button](/components/button)` component. Make sure you have it installed in your project.
