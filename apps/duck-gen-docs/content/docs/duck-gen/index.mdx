---
title: duck gen
description: Core setup and usage for Duck Gen.
---
...
- `framework` (string, default: `nestjs`): The server framework. Unsupported
  values emit a warning and fall back to `nestjs`.
