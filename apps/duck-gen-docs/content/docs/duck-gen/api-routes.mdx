...
Duck Gen is designed for multiple frameworks. This guide documents the current NestJS adapter
...
| `RouteMethods` | Union of all HTTP methods used by routes. |
| `PathsByMethod` | Filters route paths by method. |
