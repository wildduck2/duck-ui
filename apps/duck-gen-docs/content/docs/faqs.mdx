...
<Accordion type="multiple" collapsible className="w-full">
  ...
  <AccordionItem value="config-location">
    ...
    <AccordionContent className="text-muted-foreground">
      Duck Gen reads <code className="rounded bg-muted px-2 py-1">duck-gen.toml</code> from your project root. All paths
  ...
  <AccordionItem value="config-required">
    ...
    <AccordionContent className="text-muted-foreground">
      No. If <code className="rounded bg-muted px-2 py-1">duck-gen.toml</code> is missing, Duck Gen uses defaults.
  ...
  <AccordionItem value="output-location">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      You can override each output with
      <code className="ml-2 rounded bg-muted px-2 py-1">extensions.apiRoutes.outputPath</code> and
      <code className="ml-2 rounded bg-muted px-2 py-1">extensions.messages.outputPath</code>.
      Both accept a single path or a list of paths.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="import-types">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      <div className="mt-3">
        <code className="rounded bg-muted px-2 py-1">import type &#123; RouteReq, RouteRes, ApiRoutes, DuckgenMessageGroup &#125; from '@gentleduck/gen/nestjs'</code>
      </div>
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="scan-control">
    ...
    <AccordionContent className="text-muted-foreground">
      Use <code className="rounded bg-muted px-2 py-1">sourceGlobs</code>,
      <code className="ml-2 rounded bg-muted px-2 py-1">tsconfigPath</code>, and
      <code className="ml-2 rounded bg-muted px-2 py-1">includeNodeModules</code> under
      <code className="ml-2 rounded bg-muted px-2 py-1">extensions.shared</code> (or override per extension).
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="disable-extensions">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      <code className="ml-2 rounded bg-muted px-2 py-1">false</code> in <code className="rounded bg-muted px-2 py-1">duck-gen.toml</code>.
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="missing-routes">
    ...
    <AccordionContent className="text-muted-foreground">
      ...
      <ul className="mt-2 list-disc pl-5">
        ...
        <li>Your <code className="rounded bg-muted px-2 py-1">sourceGlobs</code> do not include the files.</li>
