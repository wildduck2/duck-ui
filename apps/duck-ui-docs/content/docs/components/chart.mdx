...
**Note:** We're working on upgrading to Recharts v3. In the meantime, if you'd like to start testing v3. We'll have an official release soon.
...
<ComponentSource name="chart-1" title="components/example-chart.tsx" />
